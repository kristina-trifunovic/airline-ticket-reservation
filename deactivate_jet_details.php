...
<html>
	...
	<body>
		...
		<form action="deactivate_jet_details_form_handler.php" method="post">
			<h2>UNESITE AVION KOJI ZELITE DA DEAKTIVIRATE</h2>
			<div>
			<?php
				if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<strong style='color: green'>Avion je uspesno deaktiviran.</strong>
						<br>
						<br>";
				}
			...
			<br>
			<input type="submit" value="Deaktiviraj" name="Deactivate">
			</div>
		</form>
	</body>
</html>