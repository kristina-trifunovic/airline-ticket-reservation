	...
	<body>
		<?php
			if(isset($_POST['Submit']))
			{
				...
				{
					$data_missing[]='broj sedista(ekonomska)';
				}
				else
				{
				...
				{
					$data_missing[]='broj sedista(biznis)';
				}
				else
				{
